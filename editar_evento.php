...
if (!$idevento || !is_numeric($idevento)) {
    header("Location: eventos.php?erro=" . urlencode("ID de evento inválido"));
    exit;
}
...
if (!$evento) {
    header("Location: eventos.php?erro=" . urlencode("Evento não encontrado"));
    exit;
}

if ($evento['organizador_id'] != $idusuario_logado) {
    header("Location: eventos.php?erro=" . urlencode("Você não tem permissão para editar este evento"));
    exit;
}
    ...
    <div class="container">
        ...
        <main class="feed">
            <header class="eventos-header">
                <h1>Editar Evento</h1>
                <a href="eventos.php" class="btn-voltar">
            ...
            <div class="form-container">
                <form method="POST" action="processar_evento.php" enctype="multipart/form-data" class="evento-form">
                    ...
                    <div class="form-actions">
                        <a href="eventos.php" class="btn-cancelar">Cancelar</a>
