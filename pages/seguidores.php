    ...
    <div class="usuario">
        ...
        <div>
            <?php if ($jaSeguindo): ?>
                ...
                <a href="../actions/deixar_seguir.php?idseguidor=<?= $usuarios[$i]['idusuarios'] ?>">Deixar de seguir</a>
            <?php else: ?>
                <!-- Caso contrário, mostrar opção de seguir -->
                <a href="../actions/seguir.php?idseguidor=<?= $usuarios[$i]['idusuarios'] ?>">Seguir</a>
            <?php endif; ?>
        </div>
    </div>
<?php 
