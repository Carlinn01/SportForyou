        ...
        <main class="feed">
            <header class="eventos-header">
                ...
                <div class="header-actions">
                    <a href="criar_evento.php" class="btn-cadastrar-eventos">
            ...
            <div class="eventos-grid">
                <?php if (empty($eventos)): ?>
                    <div class="sem-eventos">
                        ...
                        <a href="criar_evento.php" class="btn-cadastrar-eventos">Cadastrar Primeiro Evento</a>
                    </div>
                <?php else: ?>
                            ...
                            <div class="evento-content">
                                ...
                                <?php if ($evento['organizador_id'] == $idusuario_logado): ?>
                                    <div class="evento-acoes">
                                        <a href="editar_evento.php?id=<?= $evento['idevento'] ?>" class="btn-editar-evento">
                                            <i class="fa-solid fa-pen"></i> Editar
                                        </a>
                                        <a href="deletar_evento.php?id=<?= $evento['idevento'] ?>" class="btn-deletar-evento" onclick="return confirm('Tem certeza que deseja deletar este evento?')">
